...
public class GroupFloatActionBar  extends ViewGroup{
    ...
    public GroupFloatActionBar(Context context) {
        this(context,null);
    }

    public GroupFloatActionBar(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public GroupFloatActionBar(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr,0);
    }

    public GroupFloatActionBar(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public void setTranslation(View view,int angle){
        ...
        /**
         * 此处需要特别注意
         * 1.View相对父视图真实显示的X坐标 = left + translateX
         * Y坐标是 Y = Top + translateY
         * left 和Top都是布局属性，在layout方法中就被确定下来了
         * 无论View如何变换位置 left 和 top属性都不会变
         * 2.假如属性动画只穿一个值的话，那就是当前->目标的变化
         */
